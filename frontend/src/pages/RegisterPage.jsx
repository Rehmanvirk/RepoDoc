      ...
      <div style={styles.pageWrapper}>
        <div style={styles.container} className="aperture-stagger-in">
          ...
          <div style={styles.logoSection}>
            ...
            <p style={styles.tagline}>Start Your Documentation Journey</p>
          </div>

          {/* Register Card */}
          <div style={styles.registerCard} className="aperture-glass-card">
            <h2 style={styles.heading}>Create Account</h2>
            <p style={styles.subheading}>Join thousands of developers automating their docs</p>
            ...
            <div style={styles.formWrapper}>
              ...
              <div style={styles.footer}>
                ...
                <Link to="/login" style={styles.footerLink} className="aperture-link">
                  Sign In
                </Link>
              </div>
            </div>
